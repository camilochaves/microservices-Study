    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, Email = "aline@gmail.com", Role = "user", Password = "1234" },
                new User { Id = 2, Email = "teste@gmail.com", Role = "user", Password = "1234"},
                new User { Id = 3, Email = "camilo@gmail.com", Role = "admin", Password = "1234"}
                );
        }
    }
}
